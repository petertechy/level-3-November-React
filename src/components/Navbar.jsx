    ...
    <>
      <div className="row">
        ...
        <div className="col-7">
          ...
          <li><Link className="text-success" to="/register">Register</Link></li>
          <li><Link className="text-success" to="/signin">Sign In</Link></li>
          <li><Link className="text-success" to="/user-dashboard">Dashboard</Link></li>
